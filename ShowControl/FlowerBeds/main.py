...
def run(args: argparse.Namespace) -> None:
    ...
    if args.mock_camera:
        ...
        camera = OrbbecCamera(
            width=cam_cfg.width, height=cam_cfg.height, fps=cam_cfg.framerate,
            mirror=cam_cfg.mirror,
        )
        log.info("Using Orbbec camera (auto-discover, mirror=%s)", cam_cfg.mirror)
